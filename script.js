    ...
    function groupTableRows(tbody) {
        ...
        rows.forEach((row) => {
            if (row.id) {
                ...
                if (interval) {
                    currentGroup.intervals.push(...getIntervalsFromString(interval.textContent.trim()));
                }
            }
        });
    ...
    function renderGroupInfo(groupedRows) {
        ...
        groupedRows.forEach((group) => {
            ...
            if (headerRow) {
                ...
                const overlapTimeElement = renderOverlapTimeElement(group.totalOverlapTimeMs);
